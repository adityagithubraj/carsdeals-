  ...
  return (
    <>
      <div className="home-banner p-10 flex flex-col justify-between">
        <div className="flex flex-col justify-center lg:items-baseline items-center gap-y-8 banner-txt">
          <h1 className="text-white lg:text-6xl lg:leading-[5rem] text-[45px] leading-[3.5rem] text-center lg:text-left ">
            Experience the thrill <br />
            of the road with our
            <br /> top-notch cars!"
          </h1>
          <p className="text-white text-3xl text-center lg:text-left w-full">
